...
<body>
    ...
    <main>
        ...
        <form action="borrar_repuesto.php" method="POST" class="ctd-app">
            <div id="ctd-btns">
                <a href="add_repuesto.php" id="btn-add-cliente">
                    Añadir repuesto
                </a>
            ...
            <?php
                ...
                $sql = "SELECT Referencia,Descripcion FROM repuestos ORDER BY Referencia";
                ...
                foreach($rows as $row){
                    ...
                    echo "<tr>
                                ...
                                <td>
                                    <a href='editar_repuesto.php?referencia=$referencia' style='color: darkblue;text-decoration:underline!important;'>
