...
<body>
    ...
    <main>
        ...
        <form action="borrar_factura.php" method="POST" class="ctd-app">
            <div id="ctd-btns">
                <a href="add_factura.php" id="btn-add-cliente">
                    Añadir factura
                </a>
            ...
            <?php
                ...
                $sql1 = "SELECT Numero_Factura FROM factura ORDER BY Numero_Factura";
                ...
                foreach($rows as $row){
                    ...
                    /* $sql2 = "SELECT Id_Det_Factura FROM detalle_factura WHERE Numero_Factura='$num_factura'
                            ORDER BY Id_Det_Factura"; */

                    echo "<tr>
                                <td>
                                    <center>
                                        <input type='checkbox'
                                        name='borrar[]' value='$num_factura'>
                                    </center>  
                                </td>
                                <td>
                                    <a href='editar_factura.php?Numero_Factura=$num_factura' style='color: darkblue;text-decoration:underline!important;'>
