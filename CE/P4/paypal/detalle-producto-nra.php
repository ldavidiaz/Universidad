...
<body>
    <header>
        <a href="tienda-no-retorno.html" style="cursor: hand;">
            <img src="img/logoPequeno.png" height="85px">
        </a>  
    </header>
    <main>
        <div id="tipo-tienda">
            <a href="tienda-no-retorno.html" class="version-tienda" style="color: #f0bb0f;">Versión sin retorno automático</a>
            <span> | </span>
            <a href="tienda-retorno-automatico" class="version-tienda" style="text-decoration: underline;">Versión con retorno automático</a>
        </div>
